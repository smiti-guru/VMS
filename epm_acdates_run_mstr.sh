...
/apps/dev/epm/script/`basename $0 .sh`.btq > /apps/dev/epm/script/`basename $0 .sh`_btq.tmp
bteq < /apps/dev/epm/script/`basename $0 .sh`_btq.tmp

rm /apps/dev/epm/script/`basename $0 .sh`_btq.tmp
